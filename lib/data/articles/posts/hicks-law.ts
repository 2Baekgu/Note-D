...
export const hicksLaw: Article = {
  ...
  content: `### 힉의 법칙(Hick's Law)란?

**"선택지가 많을수록 사용자가 결정을 내리는 데 시간이 더 오래 걸린다."**

즉, **사용자가 선택해야 할 옵션이 많아질수록 인지 부하가 증가하고, 의사결정 시간이 길어진다**는 심리학 및 UX 디자인 원칙입니다.

---

## 🔹 힉의 법칙의 공식

🧮 **RT=a+blog⁡2(n)RT = a + b \\log_2(n)RT=a+blog2(n)**
...
즉, **선택할 옵션이 많아질수록(log 함수에 따라) 반응 시간이 증가**합니다.

---

## 🔹 연구 사례

- [컬럼비아 대학에서 수행한 유명한 연구](https://www.nytimes.com/2010/02/27/your-money/27shortcuts.html) 에서 한 연구팀이 잼 샘플 부스를 세웠습니다. 몇 시간마다 24가지 잼에서 6가지 잼으로 바뀌었습니다. 잼이 24개 있을 때는 60%의 고객이 샘플을 받기 위해 멈추었고, 이 고객 중 3%가 병을 샀습니다. 잼이 6개 전시되었을 때는 40%만 멈췄습니다. 하지만 흥미로운 점은 이 사람들 중 30%가 잼을 샀다는 것입니다. **많은 선택 사항이 고객을 끌어들여 둘러보게 했지만, 구매로 이어지지는 않았습니다.**
...
이들은 **완벽한 결정보다 "적당히 괜찮은 결정"을 선호하는 사람들**입니다. 옵션을 어느 정도 고려하긴 하지만, 결정 과정에 과도하게 집착하지 않습니다.

- 모든 정보를 철저하게 분석하지 않기 때문에, **자신의 선택에 대해 더 만족하는 경향**이 있습니다.
- 이들은 **"충분히 괜찮다"고 판단하면 바로 선택하고 넘어가는 스타일**입니다.
...
이들은 **최선의 결정을 내리고 싶어하는 사람들**입니다. 가능한 모든 옵션을 철저히 분석해야만 선택할 수 있습니다.

- 스워스모어 대학(Swarthmore College)의 연구에 따르면, 극대화형 사람들은 **삶의 만족도, 행복감, 낙관주의, 자존감이 만족형 사람들보다 훨씬 낮게 나타났습니다.**
- 또한, 극대화형 사람들은 **후회와 우울감을 더 자주 경험**한다고 합니다.
...
1. **사용자 경험(UX) 개선** → 불필요한 선택지를 줄이면 빠르고 효율적인 의사결정 가능
2. **인지 부하 감소** → 사용자가 혼란스럽지 않도록 정보량을 조절
3. **전환율(Conversion Rate) 증가** → 선택이 쉬워지면 더 많은 사용자가 행동을 취함
...
![힉의 법칙 (Hick’s Law)](/images/hicks-law/02.png)
...
![힉의 법칙 (Hick’s Law)](/images/hicks-law/03.png)

![힉의 법칙 (Hick’s Law)](/images/hicks-law/04.png)
...
![힉의 법칙 (Hick’s Law)](/images/hicks-law/05.png)
...
![힉의 법칙 (Hick’s Law)](/images/hicks-law/06.png)
