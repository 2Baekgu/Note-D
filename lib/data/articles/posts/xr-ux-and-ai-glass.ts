...
export const xrUxAndAiGlass: Article = {
  ...
  content: `## 스마트폰 이후의 디바이스는 무엇일까?

우리는 하루에도 수십 번 정보를 확인하기 위해, 메시지를 읽기 위해, 길을 찾기 위해 스마트폰을 꺼낸다.

하지만 이 모든 행동에는 공통점이 있다. **하던 일을 멈추고, 화면을 바라봐야 한다는 점**이다.

기술은 점점 더 똑똑해졌지만, UX는 여전히 사용자의 **주의를 끊어내는 방식**에 머물러 있다.
이 지점에서 빅테크 기업들은 하나의 질문을 던지기 시작한다.

**“화면을 보지 않아도 되는 UX는 가능할까?” **이 질문에서 출발한 것이 바로 **XR UX**다.

---

![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/02.png "https://www.youtube.com/watch?v=l5q2mEkQ22g")

### XR UX는 무엇을 다루는 UX일까?

XR UX는 가상(VR), 혼합(MR), 증강(AR)을 포괄하는 확장현실 환경에서 사용자의 **지각·행동·맥락**을 중심으로 경험을 설계하는 사용자 경험 디자인을 의미한다. 중요한 점은 XR UX가 새로운 디바이스나 기술을 설명하는 용어가 아니라, **현실과 디지털이 동시에 작동하는 상황에서의 UX 관점**이라는 점이다.
...
![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/03.png "https://www.youtube.com/watch?v=l5q2mEkQ22g")
...
AI 글래스는 기기를 ‘보는’ 대상이 아니라, **기기가 사용자의 시점을 공유하는 존재**로 만든다.
...
![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/04.png)
...
하지만 결과는 실패였다.
기술이 부족해서가 아니라, **UX가 인간의 맥락을 압도했기 때문**이다.

- 현실과 가상 정보가 동시에 입력되며 발생한 인지 부하
- 대화 중 시선 분산으로 인한 사회적 불편
- 항상 켜진 카메라로 인한 프라이버시 불안

![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/05.png)

![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/06.png)

![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/07.png)
...
![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/08.jpg)

![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/09.jpg "Microsoft HoloLens")
...
![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/10.jpg)

## 모두를 사로잡은 메타의 ‘XR UX’

메타의 AI 글래스가 주목받는 이유는 기술적으로 대단해서가 아니라, **무엇을 포기했는지가 명확했기 때문**이다.
...
![XR UX 패러다임의 전환과 AI Glass ‘최소 간섭 UX’](/images/xr-ux-and-ai-glass/11.png)
...
“이거 뭐야?”라는 질문은
UI를 가리키지 않아도 된다.
**사용자의 시야 그 자체가 컨텍스트**가 된다.

이 구조는
에고센트릭 인터랙션을
UX 이론이 아닌 **일상 행동 수준으로 끌어내린 사례**다.

### 성공 이유 4. ‘나’뿐 아니라 ‘타인’을 설계 대상에 포함했다

메타 AI 글래스는
사용자 UX만큼이나 **바이스탠더 UX**를 중요하게 다뤘다.
...
이것이 바로 XR UX가 도달한 현재의 결론이고, **최소 간섭 UX가 실현되는 방식**이다.
...
**맥락과 태도의 경쟁**이라는 사실을 다시 한 번 증명한다.

---

### Reference

[https://www.youtube.com/live/l5q2mEkQ22g](https://www.youtube.com/live/l5q2mEkQ22g)`,
};
